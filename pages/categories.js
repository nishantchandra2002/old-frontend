      ...
      <div className="main_middle profile_middle">
        <div className="col-md-6 mx-auto my-3 mt-4">
          ...
          <div className="input-group mb-4 mt-5 p-2 bg-dark rounded rounded-pill shadow-sm">
            <input
              type="text"
              className="form-control text-white rounded rounded-pill border-0 bg-info"
            ...
            <button
              className="btn ml-1 rounded rounded-pill"
