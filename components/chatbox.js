    ...
    <div className="card-header chat-list-header text-center">
         ...
         {searchText.trim() !== '' && !isLoading && isSuccess && (
           ...
           <ul className="contacts" key={i}>
            ...
            <input type="hidden" name="receiverEmail" {...register('receiverEmail')} className="receiverEmail" value={resultuser.email}/>
            <input type="hidden" name="receiverName" {...register('receiverName')} className="receiverName" value={resultuser.username}/>
